...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToSpoofVelvet.put("BRAND", "samsung");
        propsToSpoofVelvet.put("MANUFACTURER", "samsung");
        propsToSpoofVelvet.put("DEVICE", "qssi_64");
        propsToSpoofVelvet.put("PRODUCT", "e3qxxx");
        propsToSpoofVelvet.put("MODEL", "SM-S928B");
        propsToSpoofVelvet.put("ID", "UP1A.231005.007");
        propsToSpoofVelvet.put("FINGERPRINT", "samsung/e3qxxx/qssi_64:14/UP1A.231005.007/S928BXXU1AWM9:user/release-keys");
    }
