...
public final class AttestationHooks {
    ...
    public static KeyEntryResponse onGetKeyEntry(KeyEntryResponse response) {
        if (response == null)
            return null;
        /**
         * We know that the green state is what would be spoofed, orange - unlocked, yellow
         * is the only indicator of relocked bootloader, so we don't want to tamper with the
