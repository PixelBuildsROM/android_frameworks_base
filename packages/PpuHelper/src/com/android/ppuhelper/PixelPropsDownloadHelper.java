...
public class PixelPropsDownloadHelper {
    ...
    private static void initializeDlProps() {
        if (PixelPropsUtils.sCertifiedProps.length == 0 && 
            PixelPropsUtils.certCredsArr.length == 2) {
                PixelPropsUtils.sCertifiedProps = downloadAndExtractArray(
                        PixelPropsUtils.certCredsArr);
        }
    }

    private static String[] downloadAndExtractArray(String[] creds) {
